...
# DVE reload session
# Saved on Tue Oct 4 12:06:35 2022
# Designs open: 1
...
# MDI window settings
set Wave.1 Wave.1
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 557} {child_wave_right 1357} {child_wave_colname 290} {child_wave_colvalue 263} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sg_addsignal -group "$_session_group_7" { fsm_tb.buttons fsm_tb.fcw }
gui_set_radix -radix {decimal} -signals {V1:fsm_tb.fcw}
gui_set_radix -radix {unsigned} -signals {V1:fsm_tb.fcw}
...
catch { gui_list_select -id ${Data.1} {fsm_tb.buttons fsm_tb.fcw }}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 519600
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_expand -id ${Wave.1} fsm_tb.buttons
...
gui_marker_move -id ${Wave.1} {C1} 51688
