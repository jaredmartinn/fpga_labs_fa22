...
module adder_tester
  ...
  wire p_0_in;
  wire \structural_test_adder/c_1 ;
  wire \structural_test_adder/c_10 ;
  wire \structural_test_adder/c_13 ;
  wire \structural_test_adder/c_3 ;
  wire \structural_test_adder/c_4 ;
  wire \structural_test_adder/c_5 ;
  wire \structural_test_adder/c_6 ;
  wire \structural_test_adder/c_7 ;
  wire \structural_test_adder/c_8 ;
  wire \structural_test_adder/c_9 ;
  wire \structural_test_adder/nameofthisloop[10].a0/sum0__0 ;
  wire \structural_test_adder/nameofthisloop[11].a0/sum0__0 ;
  wire \structural_test_adder/nameofthisloop[12].a0/sum0__0 ;
  wire \structural_test_adder/nameofthisloop[2].a0/sum0__0 ;
  wire \structural_test_adder/nameofthisloop[5].a0/sum0__0 ;
  wire \structural_test_adder/nameofthisloop[8].a0/sum0__0 ;
  ...
  LUT2 #(
    ...
    error0_carry__0_i_10
       (.I0(adder_operand2[10]),
        ...
        .O(\structural_test_adder/nameofthisloop[10].a0/sum0__0 ));
  LUT6 #(
    .INIT(64'h6669666966696999)) 
    error0_carry__0_i_2
       (.I0(behavioral_sum[12]),
        .I1(\structural_test_adder/nameofthisloop[12].a0/sum0__0 ),
  ...
  LUT6 #(
    ...
    error0_carry__0_i_4
       (.I0(adder_operand2[12]),
        ...
        .I4(carry_out00_out__8),
        .I5(carry_out0__8),
        .O(\structural_test_adder/c_13 ));
  LUT2 #(
    .INIT(4'h6)) 
    error0_carry__0_i_5
       (.I0(adder_operand2[12]),
        .I1(adder_operand1[12]),
        .O(\structural_test_adder/nameofthisloop[12].a0/sum0__0 ));
  LUT2 #(
    .INIT(4'h8)) 
    error0_carry__0_i_6
  ...
  LUT6 #(
    ...
    error0_carry__0_i_7
       (.I0(\structural_test_adder/c_8 ),
        .I1(adder_operand1[8]),
        .I2(adder_operand2[8]),
        .I3(adder_operand1[9]),
        .I4(adder_operand2[9]),
        .I5(\structural_test_adder/nameofthisloop[10].a0/sum0__0 ),
        .O(carry_out0__8));
  LUT5 #(
    .INIT(32'h96690000)) 
    error0_carry_i_1
       (.I0(\structural_test_adder/c_9 ),
        .I1(adder_operand1[9]),
        .I2(adder_operand2[9]),
        .I3(behavioral_sum[9]),
  ...
  LUT6 #(
    ...
    error0_carry_i_10
       (.I0(behavioral_sum[7]),
        .I1(\structural_test_adder/c_7 ),
        .I2(adder_operand1[7]),
        .I3(adder_operand2[7]),
        .I4(\structural_test_adder/nameofthisloop[8].a0/sum0__0 ),
        .I5(behavioral_sum[8]),
  ...
  LUT6 #(
    ...
    error0_carry_i_13
       (.I0(behavioral_sum[4]),
        .I1(\structural_test_adder/c_4 ),
        .I2(adder_operand1[4]),
        .I3(adder_operand2[4]),
        .I4(\structural_test_adder/nameofthisloop[5].a0/sum0__0 ),
        .I5(behavioral_sum[5]),
  ...
  LUT6 #(
    ...
    error0_carry_i_14
       (.I0(behavioral_sum[1]),
        .I1(\structural_test_adder/c_1 ),
        .I2(adder_operand1[1]),
        .I3(adder_operand2[1]),
        .I4(\structural_test_adder/nameofthisloop[2].a0/sum0__0 ),
        .I5(behavioral_sum[2]),
  ...
  LUT5 #(
    ...
    error0_carry_i_15
       (.I0(adder_operand2[6]),
        ...
        .I2(adder_operand2[5]),
        .I3(adder_operand1[5]),
        .I4(\structural_test_adder/c_5 ),
        .O(\structural_test_adder/c_7 ));
  LUT5 #(
    .INIT(32'h96690000)) 
    error0_carry_i_2
       (.I0(\structural_test_adder/c_6 ),
        .I1(adder_operand1[6]),
        .I2(adder_operand2[6]),
        .I3(behavioral_sum[6]),
  ...
  LUT5 #(
    ...
    error0_carry_i_20
       (.I0(adder_operand2[9]),
        ...
        .I2(adder_operand2[8]),
        .I3(adder_operand1[8]),
        .I4(\structural_test_adder/c_8 ),
        .O(\structural_test_adder/c_10 ));
  LUT2 #(
    .INIT(4'h6)) 
    error0_carry_i_21
       (.I0(adder_operand2[11]),
        .I1(adder_operand1[11]),
        .O(\structural_test_adder/nameofthisloop[11].a0/sum0__0 ));
  LUT5 #(
    .INIT(32'hEEE8E888)) 
    error0_carry_i_22
       (.I0(adder_operand2[4]),
        ...
        .I2(adder_operand2[3]),
        .I3(adder_operand1[3]),
        .I4(\structural_test_adder/c_3 ),
        .O(\structural_test_adder/c_5 ));
  LUT2 #(
    .INIT(4'h6)) 
    error0_carry_i_27
       (.I0(adder_operand2[8]),
        .I1(adder_operand1[8]),
        .O(\structural_test_adder/nameofthisloop[8].a0/sum0__0 ));
  LUT5 #(
    .INIT(32'h96690000)) 
    error0_carry_i_3
       (.I0(\structural_test_adder/c_3 ),
        .I1(adder_operand1[3]),
        .I2(adder_operand2[3]),
        .I3(behavioral_sum[3]),
  ...
  LUT3 #(
    ...
    error0_carry_i_32
       (.I0(adder_operand2[3]),
        .I1(adder_operand1[3]),
        .I2(\structural_test_adder/c_3 ),
        .O(\structural_test_adder/c_4 ));
  LUT2 #(
    .INIT(4'h6)) 
    error0_carry_i_33
       (.I0(adder_operand2[5]),
        .I1(adder_operand1[5]),
        .O(\structural_test_adder/nameofthisloop[5].a0/sum0__0 ));
  LUT2 #(
    .INIT(4'h8)) 
    error0_carry_i_34
       (.I0(adder_operand1[0]),
        .I1(adder_operand2[0]),
        .O(\structural_test_adder/c_1 ));
  LUT2 #(
    .INIT(4'h6)) 
    error0_carry_i_35
       (.I0(adder_operand2[2]),
        .I1(adder_operand1[2]),
        .O(\structural_test_adder/nameofthisloop[2].a0/sum0__0 ));
  LUT6 #(
    .INIT(64'hEEE8EEE8EEE8E888)) 
    error0_carry_i_36
       (.I0(adder_operand2[7]),
  ...
  LUT6 #(
    ...
    error0_carry_i_38
       (.I0(\structural_test_adder/c_3 ),
        ...
        .I3(adder_operand1[4]),
        .I4(adder_operand2[4]),
        .I5(\structural_test_adder/nameofthisloop[5].a0/sum0__0 ),
        .O(carry_out0__3));
  LUT4 #(
    .INIT(16'h6900)) 
    error0_carry_i_4
  ...
  LUT5 #(
    ...
    error0_carry_i_5
       (.I0(adder_operand2[8]),
        ...
        .I2(adder_operand2[7]),
        .I3(adder_operand1[7]),
        .I4(\structural_test_adder/c_7 ),
        .O(\structural_test_adder/c_9 ));
  (* OPT_MODIFIED = "SWEEP" *) 
  ...
  LUT6 #(
    ...
    error0_carry_i_7
       (.I0(behavioral_sum[10]),
        .I1(\structural_test_adder/c_10 ),
        .I2(adder_operand1[10]),
        .I3(adder_operand2[10]),
        .I4(\structural_test_adder/nameofthisloop[11].a0/sum0__0 ),
  ...
  LUT3 #(
    ...
    error0_carry_i_8
       (.I0(adder_operand2[5]),
        .I1(adder_operand1[5]),
        .I2(\structural_test_adder/c_5 ),
        .O(\structural_test_adder/c_6 ));
  (* OPT_MODIFIED = "SWEEP" *) 
