...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _3626_archive_1.so
_3626_archive_1.so : archive.8/_3626_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../counter_testbench.tb.daidir//_3626_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../counter_testbench.tb.daidir//_3626_archive_1.so $@
